...
export default function ParkinHome() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{fontFamily:"'Inter','Segoe UI',sans-serif"}}>
      ...
      {chatOpen && (
        <div className="fixed bottom-[90px] left-6 z-50 w-[360px] bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200" style={{maxHeight:'500px'}}>
          {/* Chat Header */}
          <div className="bg-[#00565B] px-5 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src="/images/HappinessMeter.png" alt="" className="w-8 h-8"/>
              <div>
                <h4 className="text-white font-bold text-[15px]">Parkin Support</h4>
                <p className="text-[#3ECDC6] text-[12px]">Online</p>
              </div>
            </div>
          ...
          {/* Chat Body */}
          <div className="p-5 h-[300px] overflow-y-auto bg-gray-50">
            <div className="bg-[#E0F5F3] rounded-2xl rounded-tl-none px-4 py-3 max-w-[80%] mb-3">
              <p className="text-[#00565B] text-[14px]">Hello! Welcome to Parkin. How can we help you today?</p>
            </div>
          </div>
          {/* Chat Input */}
          <div className="p-4 border-t border-gray-200 flex items-center gap-3">
            <input
              ...
              className="flex-1 bg-gray-100 rounded-full px-4 py-2.5 text-[14px] outline-none focus:ring-2 focus:ring-[#00565B]/30"
            />
            <button className="w-[40px] h-[40px] bg-[#00565B] rounded-full flex items-center justify-center hover:bg-[#004a4f] transition-colors">
      ...
      {/* Chat Toggle Button with HappinessMeter face */}
      <button
        className="fixed bottom-6 left-6 z-50 w-[60px] h-[60px] rounded-full shadow-lg flex items-center justify-center hover:scale-110 transition-transform bg-white border-2 border-[#00565B]"
        onClick={()=>setChatOpen(!chatOpen)}
        aria-label="Chat with us"
      >
        {chatOpen
          ? <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#00565B" strokeWidth="2"><path d="M18 6L6 18M6 6l12 12"/></svg>
          : <img src="/images/HappinessMeter.png" alt="Chat" className="w-[40px] h-[40px]"/>
        }
      </button>
    </div>
  );
